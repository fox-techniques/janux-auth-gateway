...
Defines the base API routes for the JANUX Feedback microservice.
...
async def root():
    """
    Root endpoint to welcome users to the JANUX Feedback microservice.

    Returns:
        dict: A welcome message.
    """
    logger.info("Root endpoint accessed.")
    return {"message": "Welcome to the JANUX Feedback microservice!"}
